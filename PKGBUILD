...
license=('Apache-2.0')
depends=('fontconfig')
makedepends=('cmake' 'extra-cmake-modules' 'git' 'python3' 'microsoft-gsl' 'fmt' 'ninja' 'qt6-5compat' 'qt6-base' 'qt6-declarative' 'qt6-multimedia' 'harfbuzz' 'fontconfig' 'catch2' 'range-v3' 'yaml-cpp' 'libutempter')
